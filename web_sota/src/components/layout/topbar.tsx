...
const THEME_KEY = "robotics-light-mode";
            ...
            >
              ...
              {APPS_CATALOG.map((app) => (
                <DropdownMenu.Item key={app.name} asChild>
                  <a
                    href={app.url}
                    className="flex items-center px-2 py-2 text-sm text-slate-300 hover:text-white hover:bg-slate-800 rounded-md transition-colors"
                    target="_blank"
