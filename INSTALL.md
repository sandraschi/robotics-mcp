...
4. Start the server:
   ...
   uv run python -m robotics_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn robotics_mcp.server:app --port 10706
   ```
5. Open `http://localhost:10706` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/robotics-mcp/issues) |
