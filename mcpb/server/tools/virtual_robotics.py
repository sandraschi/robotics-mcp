...
class VirtualRoboticsTool:
    ...
    async def _spawn_in_vrchat(
        ...
        **kwargs: Any,
        ...
        if "vrchat" not in self.mounted_servers and "osc" not in self.mounted_servers:
            raise ValueError(
                "VRChat spawn requires vrchat-mcp or osc-mcp server. Configure mounted_servers with vrchat or osc."
            )
    ...
    async def _spawn_in_unity(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ValueError("Unity spawn requires unity3d-mcp server. Configure mounted_servers with unity.")
    ...
    async def _test_navigation(self, robot_id: str | None, environment: str | None) -> dict[str, Any]:
