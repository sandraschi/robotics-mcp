...
def test_config_loader_missing_file_returns_defaults():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert config["robotics"]["moorebot_scout"]["mock_mode"] is False
...
def test_config_loader_save_and_reload():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        test_config = {"robotics": {"moorebot_scout": {"enabled": True, "robot_id": "test_scout", "port": 9090}}}
...
def test_config_loader_default_config_structure(tmp_path: Path):
...
def test_config_loader_partial_config_merges():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        partial_config = {"robotics": {"moorebot_scout": {"enabled": True}}}
