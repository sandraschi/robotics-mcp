        ...
        while True:
            try:
                ...
                if len(data) > 32:
                    ...
                    device_info = {"ip": ip, "raw_data": data.hex(), "timestamp": time.time()}
...
def extract_token_from_cloud(username: str, password: str, country: str = "us") -> dict[str, Any] | None:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if result.get("code") == 0:
                ...
                print("✅ Cloud login successful!")
                print(f"   User ID: {user_id}")
                print(f"   Token: {token}")

                return {"user_id": user_id, "token": token, "country": country}
...
def try_common_tokens(robot_ip: str) -> str | None:
