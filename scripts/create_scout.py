...
async def create_scout_model():
    ...
    # Get the robot_model_create tool
    # The tool is registered as part of robot_model_tools
    # We need to call it via the MCP client
    
    try:
        async with Client(server.mcp) as client:
            print("Calling robot_model_create tool...")
