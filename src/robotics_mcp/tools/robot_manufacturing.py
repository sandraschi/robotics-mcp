...
class RobotManufacturingTool:
    ...
    async def _octoprint_stop_print(self, device_id: str) -> dict[str, Any]:
        ...
        try:
            return format_success_response("Print stopped", data={"device_id": device_id, "status": "stopped"})
        except Exception as e:
    ...
    async def _octoprint_pause_print(self, device_id: str) -> dict[str, Any]:
        ...
        try:
            return format_success_response("Print paused", data={"device_id": device_id, "status": "paused"})
        except Exception as e:
    ...
    async def _octoprint_resume_print(self, device_id: str) -> dict[str, Any]:
        ...
        try:
            return format_success_response("Print resumed", data={"device_id": device_id, "status": "printing"})
        except Exception as e:
