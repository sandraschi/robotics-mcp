...
class DroneControlTool:
    ...
    def register(self):
        ...
        async def drone_control(
            ...
            try:
                ...
                self.logger.error(
                    "Drone control operation failed",
                    operation=operation,
                    drone_id=drone_id,
                    error=str(e),
                )
                return format_error_response(f"Drone control failed: {e!s}")
        ...
        async def drone_streaming(
            ...
            try:
                ...
                self.logger.error(
                    "Drone streaming operation failed",
                    operation=operation,
                    drone_id=drone_id,
                    error=str(e),
                )
                return format_error_response(f"Drone streaming failed: {e!s}")
        ...
        async def drone_navigation(
            ...
            altitude: float | None = None,
            waypoints: list[dict[str, float | None]] | None = None,
            fence_points: list[dict[str, float | None]] | None = None,
            ...
            try:
                ...
                self.logger.error(
                    "Drone navigation operation failed",
                    operation=operation,
                    drone_id=drone_id,
                    error=str(e),
                )
                return format_error_response(f"Drone navigation failed: {e!s}")
        ...
        async def drone_flight_control(
            ...
            mission_plan: dict[str, Any | None] | None = None,
            ...
            try:
                ...
                self.logger.error(
                    "Drone flight control operation failed",
                    operation=operation,
                    drone_id=drone_id,
                    error=str(e),
                )
                return format_error_response(f"Drone flight control failed: {e!s}")
    ...
    async def _drone_land(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "command": "land", "status": "executing"},
        )

    async def _drone_move(
        self, drone, velocity_x: float, velocity_y: float, velocity_z: float, yaw_rate: float
    ) -> dict[str, Any]:
    ...
    async def _drone_stop(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "command": "stop", "status": "completed"},
        )
    ...
    async def _drone_rtl(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "command": "rtl", "status": "executing"},
        )
    ...
    async def _set_flight_mode(self, drone, mode: str) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "flight_mode": mode, "status": "completed"},
        )

    async def _arm_drone(self, drone) -> dict[str, Any]:
        """Arm drone motors."""
        return format_success_response(
            f"Drone {drone.id} armed", {"drone_id": drone.id, "armed": True, "status": "completed"}
        )
    ...
    async def _disarm_drone(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "armed": False, "status": "completed"},
        )
    ...
    async def _calibrate_drone(self, drone, calibration_type: str) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "calibration_type": calibration_type, "status": "executing"},
        )
    ...
    async def _emergency_stop(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "emergency_stop": True, "status": "completed"},
        )
    ...
    async def _start_fpv_stream(self, drone, quality: str) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "stream_type": "fpv", "quality": quality, "status": "streaming"},
        )
    ...
    async def _stop_fpv_stream(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "stream_type": "fpv", "status": "stopped"},
        )
    ...
    async def _set_stream_quality(self, drone, quality: str, bitrate: int | None) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "quality": quality, "bitrate": bitrate, "status": "updated"},
        )
    ...
    async def _start_recording(self, drone, filename: str | None) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "recording": True, "filename": filename, "status": "recording"},
        )
    ...
    async def _stop_recording(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "recording": False, "status": "stopped"},
        )
    ...
    async def _take_snapshot(self, drone, filename: str | None) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "snapshot": filename, "status": "completed"},
        )
    ...
    async def _follow_waypoints(self, drone, waypoints: list[dict] | None) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "waypoints": waypoints, "status": "executing"},
        )
    ...
    async def _clear_waypoints(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "waypoints_cleared": True, "status": "completed"},
        )
    ...
    async def _disable_follow_me(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "follow_me": False, "status": "inactive"},
        )
    ...
    async def _set_home_location(self, drone, lat: float, lon: float) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "home": {"lat": lat, "lon": lon}, "status": "set"},
        )
    ...
    async def _set_flight_mode_advanced(self, drone, mode: str) -> dict[str, Any]:
        ...
        return format_success_response(
            f"Drone {drone.id} flight mode set to {mode}",
            {"drone_id": drone.id, "flight_mode": mode, "status": "active"},
        )
    ...
    async def _get_flight_modes(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "available_modes": modes, "current_mode": "MANUAL"},
        )
    ...
    async def _start_mission(self, drone, mission_id: str | None) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "mission_id": mission_id, "status": "executing"},
        )

    async def _pause_mission(self, drone) -> dict[str, Any]:
        """Pause current mission."""
        return format_success_response(
            f"Drone {drone.id} mission paused", {"drone_id": drone.id, "mission_status": "paused"}
        )
    ...
    async def _resume_mission(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "mission_status": "executing"},
        )

    async def _abort_mission(self, drone) -> dict[str, Any]:
        """Abort current mission."""
        return format_success_response(
            f"Drone {drone.id} mission aborted", {"drone_id": drone.id, "mission_status": "aborted"}
        )
    ...
    async def _download_mission(self, drone) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "mission_data": {"waypoints": []}},
        )
    ...
    async def _set_parameter(self, drone, param_name: str, param_value: Any) -> dict[str, Any]:
        ...
        return format_success_response(
            ...
            {"drone_id": drone.id, "parameter": param_name, "value": param_value, "status": "set"},
        )
    ...
    async def _get_parameters(self, drone, param_names: list[str] | None) -> dict[str, Any]:
        ...
        return format_success_response(
            f"Drone {drone.id} parameters retrieved", {"drone_id": drone.id, "parameters": params}
        )
